      ...
      <div className="flex h-screen flex-col items-center bg-[#FAFAFA]">
        ...
        <div className="fixed top-[48px] mx-[24px] mt-[48px] flex min-w-[327px] flex-col gap-[40px]">
          ...
          <div className="flex flex-col gap-[16px]">
            <div className="flex h-[48px] min-w-[327px] items-center rounded-[5px] bg-white px-[20.11px] py-[16px] text-[12px]/[100%]">
              <input
                type="text"
            ...
            <div className="flex h-[48px] min-w-[327px] items-center justify-center gap-[10px] rounded-[5px] bg-white">
              <button>All</button>
